...
- GitHub Actions runs all tests and reports coverage to Coveralls on trusted builds using the `TYPESAFE_API_KEY` repository secret. Fork and Dependabot pull requests run deterministic tests only.
